...
#map string to a callable that returns a Gamecharacter and dont know how many args it will take
...
def unregister(character_type: str) -> None:
    ...
    character_creation_funcs.pop(character_type, None) #default None value if not have that in dictionary
