...
class Delivery:
    ...
    avoid_zones: list[GeoFence] | None = None # better default to have empty list instead of None
...
def assign_delivery(
    ...
    if diagnostics is not None: # Have multiple reference to check for None
