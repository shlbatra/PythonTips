...
def fetch_joke() -> str:
    ...
    with httpx.Client() as client:
        response = client.get("https://api.chucknorris.io/jokes/random", timeout=2.0) # Wait max 2 seconds for response
...
def main() -> None:
    joke: str = retry(fetch_joke, retries=3, delay=1.0) # Retry up to 3 times with 1 second delay via a method accepting a function
    print(joke)
