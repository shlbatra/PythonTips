...
class PersonSlots:
    __slots__ = "name", "address", "email" #list of attributes python should use and not dictionary
    #python will generate descriptors for each attribute in slot
    def __init__(self, name: str, address: str, email: str):
        self.name = name
        self.address = address
        self.email = email
...
def get_set_delete(person: Person | PersonSlots):
    """_function to check for performance
    """
