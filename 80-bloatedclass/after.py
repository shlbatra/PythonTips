...
"""
If behavior about data - validating and deriving and small behaviour property -> class
Code - broader workflow or use other arguments - keep out of class
Also can split across modules.
"""

@dataclass(frozen=True) # Only initialize once, reuse across other experiments, this class groups related data and add validations - assume these things dealt at other areas of code
class TrainingConfig:
    ...
    def __post_init__(self) -> None: # Move validation from run to closer to data
...
# Preprocessing
# ---------------------------
# Methods not share data - just pass them as arguments
...
def run_experiment(config: TrainingConfig) -> None: # Pass config as part of experiment run
