...
class Book: # Pydantic dataclass for domain model with auto-generated ID
    title: str
    author: str
    pages: int = 0
...
class BookResponse(BaseModel):
    ...
    class Config:
        from_attributes = True # Works with any object that has matching attributes ex. dict or class
