...
# focus structure of things
# real world scenario. ex. real estate system with mortgage
# using fn, need lot of fns
...
Transaction = tuple[TransactionType, datetime, int]  # structured info - simple structure
...
def main() -> None:  # use fn here - flexibility
