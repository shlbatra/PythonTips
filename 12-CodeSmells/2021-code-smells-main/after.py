...
from enum import Enum, auto  # to assign id for values use auto
...
class Employee(ABC):
    ...
    def take_a_holiday(self) -> None:
        ...
        if self.vacation_days < 1:
            # bonus code small -> raise ValueError()
            # not use built in error -> not enough holidays for payout
            # pass to own custom error types with own data and types
