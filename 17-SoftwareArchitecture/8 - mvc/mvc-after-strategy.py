...
class Controller:
    def __init__(self, model, view, generate_uuid): #generate_uuid - select which method to use
        self.model = model
        self.view = view
...
c = Controller(Model(), TkView(), generate_simple_id) #pass method here - viewid
c.start()
