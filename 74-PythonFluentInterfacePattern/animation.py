...
class Animation:
    ...
    # With add initially, return None ; New step added → return self for chaining - make it fluent
    def add(self, step: AnimationStep, duration: float) -> Self:
        self.steps.append(step)
        self.durations.append(duration)
        return self

    # fluent API - add methods that create certain action steps and add them in one go, returning self for chaining
