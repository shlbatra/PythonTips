...
def main() -> None:
    ...
    # ------------------------------------------------------------
    # square_animation = Animation(start_time=0.0); square_animation.add(Rotate(60), 1.0);
    # Change to square_animatuon.rotate(60, duration=1.0) → add the step and return self for chaining
