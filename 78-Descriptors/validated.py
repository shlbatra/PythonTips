...
Validator = Callable[[str, Any], None] # str name of field, and any value to be validated
# reusable, declarative validation system built on descriptors

def non_empty(field: str, value: Any) -> None:
    """a plain validator. Takes a field name and value, raises if invalid."""
...
def min_value(n: int) -> Validator:
    """
    a closure/factory. min_value(18) returns a new validator function that checks value >= 18. This is the same pattern as a decorator with arguments — a function that returns a function
    """
