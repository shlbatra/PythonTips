...
@cache
def compute_total_sales(path: str) -> float: # Results are cached based on path and only recomputed if path changes.
...
# Adds complexity of background preloading while keeping UI responsive. Also, code needs to be thread-safe.
def main() -> None:
    path = "sales.csv"
