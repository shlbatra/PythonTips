...
def load_sales(path: str) -> Generator[dict[str, str], None, None]: # Generator[YieldType, SendType, ReturnType] 
...
# Change UI to use streaming data processing instead of loading all data into memory.
def main() -> None:
    path = "sales.csv"
