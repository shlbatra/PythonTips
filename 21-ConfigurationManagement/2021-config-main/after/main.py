...
cs = ConfigStore.instance() # config to be instance of MNISTConfig -> use config store to link yaml to dataclass
cs.store(name="mnist_config", node=MNISTConfig) #use MNIST config dataclass

#decorator - hydra knows need to load config before running code below
...
if __name__ == "__main__":
    main() # doesnt get any parameters but hydra fills it in the fly - not work well with typing system
