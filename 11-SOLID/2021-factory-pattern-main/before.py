...
#problem - way too many responsibilities 
#1.which quality they want, 2. map quality to object 3. export
#low cohesion and lot of coupling here -> lots of instances here - know existence of all these classes here
