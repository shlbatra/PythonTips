...
from src.load_data import (load_test_data, load_test_labels, load_train_data,
                           load_train_labels)
...
class MNIST(Dataset):
    ...
    #Issue - using variable to store intermediate data
    #variable mean diff things at diff parts of app
