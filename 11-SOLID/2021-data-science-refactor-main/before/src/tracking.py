...
#Interface
#represent various stages in data science experiment -> turn to enum
...
#seperate tracking and specifics of tracking from experiment
#only have methods so remove stage from here
#remove non abstract methods
#use protocol class
#add stage and flush methods here 
...
#Implementation
#TensorboardExperiment implementation of ExperimentTracker
#put in a seperate file - tensorboard.py file
