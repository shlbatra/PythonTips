...
#use geolocation directly here
#additional flexibility - provide which geolocation run method from another part of code
#lower coupling - depend on geolocation only
