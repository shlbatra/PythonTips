#depedency inversion allows to seperate authrozer from payment processor other than 2 basic methods
#use any additional authorizer now
import random
import string
...
class Authorizer(ABC):
    @abstractmethod
    def authorize(self):
        #to pass test here for coverage, you can pass doc string instead of pass
        pass
