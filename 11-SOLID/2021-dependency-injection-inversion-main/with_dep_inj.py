...
class PaymentProcessor:
    #paymentprocessor still dependent on authorizer
    #if change another authorizer doesnt work here - so create a layer (abstraction to select any authorizer here)
