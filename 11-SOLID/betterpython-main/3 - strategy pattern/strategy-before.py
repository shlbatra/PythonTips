...
class CustomerSupport:
    ...
    def process_tickets(self):
        ...
        if len(self.tickets) == 0:
            ...
            return
        # code issue here -> if else and extend code here for new processing stratergy
        # weak cohesion as method doing diff things here 
        # create class for each method and interface -> abstractbaseclass
