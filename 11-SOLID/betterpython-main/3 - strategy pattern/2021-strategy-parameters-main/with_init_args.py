...
parameters per stratergy in initializer to have decoupling
"""
import statistics
...
#just runs stratergy and doesnt need implementation details
class TradingBot:
...
def main() -> None:
    ...
    # create the trading strategy -> set parameters here when create object
    # decoupling here
