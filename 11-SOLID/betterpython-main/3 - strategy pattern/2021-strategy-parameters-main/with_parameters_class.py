...
Parameter class that contains all parameters for stratergy 
pass instance of this parameter class
Issues 
1. Coupling as stratergies share parameter class - unrelated parameters
2. not know which parameter belong to which stratergy
can do abstract paramater class - arrays of int/float/bool sub class - still have coupling

biggest issue -

run method for trading bot needs to know implementation details for stratergy to set 
those parameters - use init args
"""
import statistics
...
class TradingBot:
    ...
    def run(self, symbol: str):
        ...
        ) #pass value for object for parameter class here
