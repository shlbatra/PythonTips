...
2 problems -
1. losing typing info, what method is expecting ?
2. only indicate one type - so not mix float and int. 
"""
import statistics
...
class AverageTradingStrategy(TradingStrategy):
    ...
    def should_buy(self, prices: list[float], **kwargs: float) -> bool:
        window_size = kwargs.get("window_size", 3.0) #get from keyword arg
