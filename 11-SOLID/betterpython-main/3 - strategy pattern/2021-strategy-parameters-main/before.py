...
Issues -> hardcoded parameters for stratergies here 
avg -> window size(3), min/max prices(harcoded) - 3 ways
"""
import statistics
...
class TradingBot:
    ...
    # Using depedency injection -> injecting depedencies of trading bot on exchange and trading stratergy
