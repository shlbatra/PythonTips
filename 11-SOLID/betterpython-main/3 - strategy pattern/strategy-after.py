...
class TicketOrderingStrategy(ABC):
    @abstractmethod
    def create_ordering(self, list: List[SupportTicket]) -> List[SupportTicket]: #type hint for list of tickets
        pass
...
class CustomerSupport:
    ...
    # process tickets not know about ordering stratergy so more cohesion
