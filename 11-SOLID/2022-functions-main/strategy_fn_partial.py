...
#simplify fn, add parameters directly the ones we need
...
def main() -> None:
    ...
    #directly use the functions here - create partially applied functions here
    #return from partial fn with the parameter passed here. ex. max_price
