...
#define callable for functions in protocol class 
# fns get in list of prices and return a bool so a callable defined as below -
TradingStrategyFunction = Callable[[list[int]], bool]

#avg stratergy fns follow TradingStrategyFunction signature
...
#minmax stratergy fns follow TradingStratergyFunction signature
...
def main() -> None:
    ...
    # supply diff combinations of fns here - extra flexibility
