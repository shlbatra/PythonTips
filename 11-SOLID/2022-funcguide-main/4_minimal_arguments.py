...
#structure data so customer doesnt have a lot of attributes so card can be sub object 
# for customer class
@dataclass
class Card:
    number: str
...
#just need an object that has protocol attribites - doesnt need any details in it
