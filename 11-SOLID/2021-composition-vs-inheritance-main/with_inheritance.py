...
Each class still has too many responsibilities after version 1 of inheritance
ex. commission and pay rate in same class so further create subclass for commission
Issue -
1. Still code duplication - commision class are same only subclass of diff class
2. for every variation add, explosion of subclasses.ex YrlyBonus - more subclasses
3. Coupling -> super().compute_pay() -> subclass assumes to know method for parent class
"""
