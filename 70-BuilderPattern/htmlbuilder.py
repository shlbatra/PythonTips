...
# Representation of the final HTML Page
...
# Using the Builder Pattern - step-by-step construction of HTMLPage and each step returns the class itself for chaining
...
class HTMLBuilder:
    ...
    def set_title(self, title: str) -> Self: # return object so chain operations
        self._title = title
        return self
