...
# args and kwargs are variable names so can be renamed, but * and ** are required syntax
...
def summarize(*floats: float) -> float: # list of floats reflected by *
    return sum(floats)
...
#   def func1(**kwargs: str): ...
#   func1(a="hello", b="world")  # ✅
#   func1(a="hello", b=123)      # ❌ type error

#   # Any type allowed
#   def func2(**kwargs: Any): ...
#   func2(a="hello", b=123, c=[1,2], d={"x": 1})  # ✅ all valid