...
# Args possible better use generics when possible and return types to be specific types

# Type annotation limits to list and fixed below 
def add_number_to_each_element(number: int, numbers: list[int]) -> list[int]:
    return [num + number for num in numbers]

# Type annotation to make fn generic ex. list or tuple
...
def add_number_to_each_element_v3[Numeric: (int, float, Decimal)]( # generic type for multiple types
