...
@lru_cache   # not recompute bmi everytime called but when inputs changed - use a function here, least recently used cache - keep mapping from args to res
...
class Address:
    ...
    def __str__(self) -> str:  # string representation of object
