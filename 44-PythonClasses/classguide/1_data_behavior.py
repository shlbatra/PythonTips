...
'''
    Convert Person class to person, address and stats class
'''
@dataclass
class Stats:
    age: int
    ...
    @cached_property  # not recompute bmi everytime called - issue when stats changed 
    def bmi(self) -> float:
...
class Person:
    ...
    def update_email(self, email: str) -> None:  # split behavior of email to seperate class
        self.email = email
