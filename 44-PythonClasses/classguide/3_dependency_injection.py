...
class EmailSender(Protocol):   # protocol class for abstraction, need  a fake send_message method for this class to work
...
class Person:
    ...
    def update_email(self, email: str, service: EmailSender) -> None:  # easy to provide custom service, abstraction for email service - protocol class
        self.email = email
