...
# Abstract class only have abstract methods -> Prefer Protocol for duct typing and not rquire abstract methods
class ExperimentTracker(ABC):
    ...
    # Non abstract methods - not reqd so remove
    ...
    # Add abstract methods that are defined in TensorBoardExperiment - set_stage and flush methods
